...
import disposeUrl from "./utils/disposeUrl"
...
Mock.mock(/^\/api\/blog(\?.+)?$/, "get", function(options) {
    const queryObj = disposeUrl(options.url);
    return  Mock.mock({
        code: 0,
        msg: "",
        data: {
            "total|2000-3000" : 0,
            [`rows|${queryObj.limit || 10}`]: [
                {
                    id: "@natural",
                    imgTitle: "@ctitle",
                    title: "@ctitle(5, 50)",
                    ...
                    "thumb|1": ["https://img2.baidu.com/it/u=1713796643,4188877777&fm=253&app=138&size=w931&n=0&f=JPEG&fmt=auto?sec=1660755600&t=3041c21aa87f2e1389d5572d0bfe2ed1", null],
                    createDate: "@date(T)",
                }
            ]
        }
...
Mock.mock(/^\/api\/blog\/[^\/]+$/, {
    ...
    data: {
        ...
        "thumb|1": ["https://img2.baidu.com/it/u=2237039644,3735368368&fm=26&fmt=auto", null],
    },
})
